...
input_file_patterns = [
    ...
    path('types/', InputFileTypesListView.as_view(),
         name='input_file_types_list'),
    ...
    path('<int:file_id>/attributes/',
         AttributeListView.as_view(), name='attribute_list'),
    path('<int:file_id>/attributes/create/',
         AttributeCreateView.as_view(), name='attribute_create'),
    path('<int:file_id>/attributes/bulk_delete/',
         AttributeBulkDeleteView.as_view(), name='attribute_bulk_delete'),
]
