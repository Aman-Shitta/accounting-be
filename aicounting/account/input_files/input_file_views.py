...
from account.models import DimAicInputFileAttributes, DimAicInputFiles
    ...
    def post(self, request, client_id, file_id, *args, **kwargs):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                response_serializer = InputFileAttributeSerializer(
                    attribute, many=True)
...
class AttributeBulkDeleteView(generics.GenericAPIView):
    ...
    def delete(self, request, client_id, file_id, *args, **kwargs):
        ...
        try:
            ...
            deleted_ids = list(
                attributes_to_delete.values_list('id', flat=True))
